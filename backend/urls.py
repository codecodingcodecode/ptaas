...
from .views import nmap_scan, nikto_scan, sslyze_scan, sqlmap_scan, wapiti_scan, combined_scan, get_progress
...
urlpatterns = [
    ...
    path('combined-scan/', combined_scan, name='combined-scan'),
    path('progress/<str:scan_id>/', get_progress, name='get-progress'),
]
